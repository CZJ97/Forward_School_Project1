...
from welcome.forms import UserForm, UserProfileInfoForm
from django.contrib.auth import authenticate, login, logout
from django.http import HttpResponseRedirect, HttpResponse
from django.urls import reverse
from django.contrib.auth.decorators import login_required
from welcome.models import UserProfileInfo
...
def dashboard(request):
    all_users = UserProfileInfo.objects.select_related('user')
    return render(request,'welcome/dashboard.html',{'all_users':all_users})
